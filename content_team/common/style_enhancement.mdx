...
<LoadComponent componentName="prompt-playground" promptTemplate="You are an AI assistant tasked with reviewing a document strictly based on the following rules. Your goal is to identify all inconsistencies or violations of the style guide, ensuring no rules are omitted during the review process.
