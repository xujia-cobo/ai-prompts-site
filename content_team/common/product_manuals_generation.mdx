...
<LoadComponent componentName="prompt-playground" promptTemplate="You are an AI assistant tasked with writing [an article / a list of articles] based on the input I'll give you later. You must do the following while writing the article:
...
4. Reference competitor documentation from:
   - Fireblocks: https://support.fireblocks.io/hc/en-us 
   To ensure:
...
6. Add appropriate links to:
   ...
   - Related documentation using relative paths (e.g., /en/portal/...)
...
7. The topic should end with this tip: <Tip>Feel free to [share your feedback](https://forms.zohopublic.com/cobo/form/DocumentFeedbackForm/formperma/QvLOhxJv1_JMsJ-1dleZ8Itb_7rzN-LtgvsDdxosoVI?referrername=manuals) to improve our documentation!</Tip>" />
